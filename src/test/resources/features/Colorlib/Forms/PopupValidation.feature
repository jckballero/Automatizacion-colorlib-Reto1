...
Feature: Formulario Popup Validation
	...
	longitud y formato, el sistema debe presentarlas validaciones respectivas
  ...
  Scenario: Diligenciamiento exitoso del formulario Popup Validation,
    ...
    When Diligencio Formulario Popup Validation
      ...
      | Valor1   | Golf   | Tennis    | Golf      |http://www.valor1.com |valor1@mail.com|valor1    |valor1    |123456  | 123456  | -99.99 | 200.200.5.4 | 2020-02-11 | 2012/09/12  |
    Then Verifico ingreso exitoso
    
  @CasoAlterno
  Scenario: Diligenciamiento con errores del formulario Popup Validation,
  					Se presento Globo Informativo indicando error en el diligenciamiento de alguno de los campos.
  					
    Given Autentico en colorlib con usuario "demo" y clave "demo"
    And Ingreso a la funcionalidad Forms Validation
    When Diligencio Formulario Popup Validation
    	| Required | Select | MultipleS1| MultipleS2|Url                   |Email          |Password1 |Password2 |MinSize | MaxSize | Number | IP          | Date       | DataEarlier |
      |          | Golf   | Tennis    | Golf      |http://www.valor1.com |valor1@mail.com|valor1    |valor1    |123456  | 123456  | -99.99 | 200.200.5.4 | 2020-02-11 | 2012/09/12  |
    	| Valor1   | Choose a sport  | Tennis    | Golf      |http://www.valor1.com |valor1@mail.com|valor1    |valor1    |123456  | 123456  | -99.99 | 200.200.5.4 | 2020-02-11 | 2012/09/12  |
